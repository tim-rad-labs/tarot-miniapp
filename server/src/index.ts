...
bot.start(async (ctx) => {
  ...
  ctx.reply(
    ...
    `Я — Майя, экспертный таролог. Помогаю находить ответы в тишине карт и видеть возможности там, где другие видят лишь тупики.\n\n` +
    `✨ Доступные расклады:\n` +
    `• Карта дня — чем дышит сегодняшний день и чего лучше избегать\n` +
    `• Три карты — Прошлое, Настоящее и возможное Будущее твоей ситуации\n` +
    `• Да/Нет — быстрый, прямой ответ, когда тянуть больше нельзя\n\n` +
    `Готов узнать, что карты приготовили для тебя?\n` +
    `Нажми кнопку ниже, чтобы начать расклад 👇`,
